...
def evaluate_warm_starting(model, reference_objective, fixed_vars: dict = None,
...
if __name__ == '__main__':
    ...
    run = wandb.init(project='sat-gnn', group=model_group,
                     job_type='warm-starting-eval', config=dict(
    ...
    for graph, model in dataset:
        ...
        ) = evaluate_warm_starting(model, quasi_optimal_objective, None,
                                   time_budget)
        ...
        for i in range(len(N)):
            ...
            if n == 0:
                ...
                (
                    ...
                    rel_primal_integral,
                    primal_curve,
                ) = evaluate_warm_starting(model, quasi_optimal_objective, fixed_vars,
                                           time_budget)
